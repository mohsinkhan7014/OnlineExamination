...
public class CandidateDetailesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_candidate_detailes);
        ...
        if (rowId != null) {
            ...
            if (c.getCount() == 0) {
                ...
                previousUser.setClickable(true);
            } else {
    ...
    private void moveToPreviousUser() {
        ...
        Intent intent = new Intent(CandidateDetailesActivity.this, AdminMainActivity.class);
    ...
    public void main(View v) {
        Intent intent = new Intent(CandidateDetailesActivity.this, IndexActivity.class);
        startActivity(intent);
